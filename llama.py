...
class RMSNorm(torch.nn.Module):
    ...
    def _norm(self, x):
        ...
        """
        # RMSNorm: normalize by root mean square of features without mean subtraction.
        # Eq.4 in https://arxiv.org/abs/1910.07467
...
class Attention(nn.Module):
    ...
    def compute_query_key_value_scores(self,
        ...
        # Train in float32; in no-grad/inference use float64 for better numerical match.
        ...
        attn = F.softmax(scores, dim=-1)
        attn = self.attn_dropout(attn)
        return torch.matmul(attn, v64).to(query.dtype)
